%RUNPCFIT_PSEUDOSYM
% Use this script to fit the pattern center to a single pattern for
...
% Output data (outputs separate file for each pseudosym variant)
data.outputprefix = 'output';    % output file will be [outputprefix]_v#.h5/txt
