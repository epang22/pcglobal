...
if exist(img_exp_path,'file')==2
    ...
    ub = [trust_L/Lfactor trust_xpc/xpcfactor trust_ypc/ypcfactor tand(trust_angle/2)/Rfactor tand(trust_angle/2)/Rfactor tand(trust_angle/2)/Rfactor]';    % upper bound
    lb = -ub;    % lower bound
